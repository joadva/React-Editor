...
let configuration : Configuration = {
  sticker={
    ...
    thumbnailURI:require("./react_png"),items: [
      {
        identifier: "demo_sticker_react",name :"React",
        stickerURI:require("./react.png")
      },
      {
        identifier: "demo_sticker_imlgy",name :"img.ly",
    ...
    <>
      ...
      <SafeAreaView>
        <ScrollView
          ...
          <Button
            title="edit Video uwur"
            onPress={() => {
              VESDK.openEditor(require('./Video/DRIMS.mp4'),configuration,serialization).then(result => {
                if (result !=null) {
